import amazon from "../assets/logos/amazon-logo.svg";
...
import googleads from "../assets/logos/googlead.svg";
import amazonads from "../assets/logos/amazon.svg";
import meta from "../assets/logos/meta.svg";
import linkdin from "../assets/logos/linkdin.svg";
import twitter from "../assets/logos/twitter.svg";
import tictok from "../assets/logos/tictok.svg";
...
export const socialMediaLogos = [
  { src: googleads, name: "Google Ads" },
  { src: tictok, name: "Tik Tok Ads" },
  { src: meta, name: "Meta" },
  { src: linkdin, name: "Linkedin Ads" },
  { src: amazonads, name: "Amazon Ads" },
