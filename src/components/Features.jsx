  ...
  return (
    <div className="flex flex-col mx-auto">
      <SectionTitle
        ...
        sectionTitle="Feature packed to make "
        sectionTitleSapn="Digital marketing easier and affordable."
        setionDesc="Experience Intelligent Features to optimize your marketing efforts."
      />
      <div className="flex flex-col desktop:grid-cols-3 sm:grid sm:grid-cols-2 gap-7 mx-auto mt-10">
        <FeatureWrapper>
          <div className="relative grid grid-flow-row justify-center max-h-full py-24">
            ...
            <div className="absolute w-64 h-64 rounded-full border-gray-600 top-28 left-12 flex items-center justify-center overflow-hidden">
              <span className="absolute w-3 h-3 bg-slate-300 rounded-full"></span>
              <span className="absolute w-32 h-32 border-gray-600 rounded-full animate-ping border"></span>
              <img
                src={avatar}
                alt="avatar"
                className="absolute animate-pulse  bottom-6"
              />
              <img
                src={avatar}
                alt="avatar"
              ...
              <img
                src={avatar}
                alt="avatar"
                className="absolute animate-pulse duration-100 right-6"
              />
              <img
                src={avatar}
                alt="avatar"
                className="absolute animate-pulse delay-75 left-6"
              />
        ...
        <FeatureWrapper>
          <div className="relative grid grid-flow-row justify-center max-h-full py-24">
            <div className="absolute w-96 h-96 border rounded-full border-gray-200 top-14 -left-4 opacity-10"></div>
            <div className="absolute w-64 h-64 rounded-full border border-gray-700 top-28 left-12 flex items-center justify-center"></div>
            <div className="absolute w-64 h-64 rounded-full border-gray-600 top-28 left-12 flex items-center justify-center ">
              <img src={flash} alt="flash" className="z-10" />
            </div>
            <div className="absolute w-36 h-36 rounded-full top-40 left-24 flex items-center justify-center animate-pingSlow">
              <img
                src={avatar}
                alt="avatar"
                className="absolute -bottom-6 w-3 h-3"
              />
              <img
                src={avatar}
                alt="avatar"
                className="absolute  -top-6 w-3 h-3"
              />
              <img
                src={avatar}
                alt="avatar"
                className="absolute -right-6 w-3 h-3"
              />
              <img
                src={avatar}
                alt="avatar"
          ...
          <div className="absolute bottom-0 w-full px-5 py-4 space-y-1 ">
            <h1 className="text-lg bg-gradient-to-r font-semibold text-transparent bg-clip-text from-gray-300 to-lightbule rounded-md">
              Intelligent Agents to Optimize
            </h1>
            <p className="font-extralight text-md">
